...
**Sérialisation**
    ...
    Passage des tableaux php et les transforme dans un autre format ( **eg** Array Json) . Du tableau php on peut *dénormaliser* a des entités doctrines.
...
Toutes les requêtes vont dans services/CustomersAPI.js

Les axios get et delete peuvent être transformé en functions externes
...
On peut changer tous .then en async / await avec try et catch
...
et handleDelete devient une fonction asynchrone
